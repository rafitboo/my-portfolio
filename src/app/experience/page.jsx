export default function Experience() {
  ...
  return (
    <section id="experience" className="max-w-6xl mx-auto px-4 py-32">
      <div className="mb-20">
        <h2 className="text-4xl font-bold text-white mb-4 border-l-8 border-[#A4D8FF] pl-4">Professional Experience</h2>
      </div>
