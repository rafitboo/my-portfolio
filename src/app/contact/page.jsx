...
import { faqs } from '@/components/FAQ'; // Updated absolute path alias
...
export default function Contact() {
  ...
  return (
    <section id="contact-page" className="max-w-6xl mx-auto px-4 py-32">
      
      <div className="mb-12">
        <h2 className="text-4xl font-bold text-white mb-4 border-l-8 border-[#A4D8FF] pl-4">Get in Touch</h2>
      ...
      <div className="bg-[#35393C] border border-gray-700/50 rounded-2xl p-8 md:p-12 mb-8 shadow-xl">
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <a href="/resume.pdf" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 bg-[#1E2124] border border-gray-600 hover:border-[#A4D8FF]/50 text-white px-6 py-3 rounded-lg font-bold transition-all duration-300 hover:shadow-[0_0_15px_rgba(164,216,255,0.4)] hover:-translate-y-0.5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-24">
        ...
        {/* LinkedIn */}
        <a href="https://linkedin.com/in/rafitboo/" target="_blank" rel="noopener noreferrer" className="bg-[#35393C] border border-gray-700/50 rounded-xl p-6 flex items-center gap-4 hover:border-[#A4D8FF]/40 transition-all duration-300 hover:shadow-[0_0_15px_rgba(164,216,255,0.2)]">
          <div className="w-12 h-12 bg-[#1E2124] rounded-lg flex items-center justify-center text-[#A4D8FF]">
        ...
        {/* GitHub */}
        <a href="https://github.com/rafitboo" target="_blank" rel="noopener noreferrer" className="bg-[#35393C] border border-gray-700/50 rounded-xl p-6 flex items-center gap-4 hover:border-[#A4D8FF]/40 transition-all duration-300 hover:shadow-[0_0_15px_rgba(164,216,255,0.2)]">
          <div className="w-12 h-12 bg-[#1E2124] rounded-lg flex items-center justify-center text-[#A4D8FF]">
