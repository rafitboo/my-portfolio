...
export default function About() {
  ...
  return (
    <section id="about-page" className="max-w-6xl mx-auto px-4 py-32">
      
      {/* 1. About Me Section */}
      <div className="mb-20">
        <h2 className="text-4xl font-bold text-white mb-8 border-l-8 border-[#A4D8FF] pl-4">
          About Me
        </h2>
        <div className="flex flex-col md:flex-row gap-12 items-start">
          <div className="flex-1 space-y-6 text-gray-400 leading-relaxed text-lg">
            ...
            <div className="pt-4 flex gap-4">
              <Link href="/contact" className="bg-[#A4D8FF] hover:bg-white text-[#1E2124] px-6 py-2.5 rounded-lg font-bold transition-all duration-300 shadow-[0_0_15px_rgba(164,216,255,0.4)] hover:shadow-[0_0_25px_rgba(164,216,255,0.8)] hover:-translate-y-0.5">
                Get in touch
              </Link>
              <a href="/resume.pdf" target="_blank" rel="noopener noreferrer" className="bg-[#35393C] border border-gray-600 hover:border-[#A4D8FF]/50 text-white px-6 py-2.5 rounded-lg font-bold transition-all duration-300 hover:shadow-[0_0_15px_rgba(164,216,255,0.4)] hover:-translate-y-0.5">
                View Resume
              </a>
            </div>
          </div>
          ...
          <div className="w-full md:w-1/3 flex justify-center">
            <div className="w-64 h-64 bg-[#1E2124] border border-gray-700 rounded-2xl overflow-hidden shadow-xl relative">
                <Image 
                  src="/photo.jpg" 
                  alt="Md. Rafiul Islam" 
                  width={256}
