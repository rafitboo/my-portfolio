...
export default function Projects() {
  ...
  return (
    <section id="projects" className="max-w-6xl mx-auto px-4 py-32">
      <div className="mb-16">
        <h2 className="text-4xl font-bold text-white mb-4 border-l-8 border-[#A4D8FF] pl-4">Engineered Systems</h2>
      </div>
